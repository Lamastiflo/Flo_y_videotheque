...
})({"cI86g":[function(require,module,exports) {
    ...
    films.forEach((film)=>{
        ...
        deleteButton.addEventListener("click", ()=>{
            (0, _sweetalert2Default.default).fire({
                ...
                text: "Vous ne pourrez pas revenir en arri\xe8re!",
                icon: "warning",
                ...
                if (result.isConfirmed) {
                    ...
                    updateTable();
                    (0, _sweetalert2Default.default).fire("Supprim\xe9!", "Le film a \xe9t\xe9 supprim\xe9.", "success");
                }
            });
        });
...
function validateFilm(title, year, author, genre) {
    let errors = [];
    if (title.length < 2) errors.push("- Le titre doit avoir au moins 2 caract\xe8res.\n");
    if (year < 1900 || year > currentYear) errors.push("- L'ann\xe9e doit \xeatre comprise entre 1900 et l'ann\xe9e en cours.\n");
    if (author.length < 5) errors.push("- L'auteur doit avoir au moins 5 caract\xe8res.\n");
    if (genre.length === 0) errors.push("- Le genre ne peut pas \xeatre vide.\n");
    return errors;
}
...
fillForm.addEventListener("submit", (event)=>{
    ...
    const year = parseInt(event.target.querySelector('input[placeholder="Ann\xe9e"]').value.trim(), 10);
    const author = event.target.querySelector('input[placeholder="R\xe9alisateur"]').value.trim();
    ...
    if (validationErrors.length === 0) {
        ...
        updateTable();
        (0, _sweetalert2Default.default).fire("Ajout\xe9 !", "Le film a \xe9t\xe9 ajout\xe9.", "success");
        addForm.style.display = "none";
    } else showErrorMessages(validationErrors);
});
filterSelect.addEventListener("change", (event)=>{
    const filter = event.target.value;
    if (filter === "alpha") films.sort((a, b)=>a.title.localeCompare(b.title));
    else if (filter === "decroissant") films.sort((a, b)=>b.years - a.years);
    updateTable();
});
updateTable();

},{"sweetalert2":"1HyFr","@parcel/transformer-js/src/esmodule-helpers.js":"9K2Eb"}],"1HyFr":[function(require,module,exports) {
/*!
* sweetalert2 v11.9.0
...
},{}],"9K2Eb":[function(require,module,exports) {
...
},{}]},["cI86g","6Bv9J"], "6Bv9J", "parcelRequire94c2")
